...
public class ApplicationRegistry implements ApplicationEventPublisherAware {
	...
	public Application register(Application application) {
		...
		if(application.getStatusInfo().getSystemStatus() != null) {
			StatusInfo appStatusInfo = application.getStatusInfo();
			existingStatusInfo.setSystemStatus(appStatusInfo.getSystemStatus());
		}
		// Customized Code End
